...
const reviews = [
  {
    id: 1,
    review:
      "For more than two decades I've been banking with ST Bank. To me the customer service is top notch you know.",
    name: "Adele Lucy",
  ...
  },
  {
    id: 2,
    review:
      "One thing very outstanding about ST Bank is the loan programe. For once I paid back a loan without being under pressure.",
    name: "John Smith",
  ...
  return (
    <section className="flex flex-col items-center justify-between gap-8 py-8">
      ...
      <p className="text-center text-white font-min  font-light">
        Get your Saves Sphere Bank account today!
      </p>
      <Link
        to="/register"
